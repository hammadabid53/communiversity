...
abstract class AppColors {
  ...
  static const Color colorPrimary = Color(0xFF228282);
  ...
  static const Color errorColor = Color(0xFFE51212);
  ...
  static const Color transparentColor = Color(0x0338686A);

  static const Color textColorPrimary = Color(0xFFBCB8B8);
  static const Color textColorSecondary = Color(0xFF808080);
  ...
  static const Color whiteshade = Color(0xFFF7F6F4);
