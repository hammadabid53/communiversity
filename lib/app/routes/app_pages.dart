...
import 'package:flutter_getx_template/app/modules/Registration_module/social_Login/view/social_login.dart';
...
import '../modules/Registration_module/social_Login/binding/social_login_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.SOCIAL_LOGIN_SCREEN,
      page: () => SocialLogin(),
